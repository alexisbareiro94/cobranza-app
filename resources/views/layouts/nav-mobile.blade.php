<nav
    ...
    <a href="{{ route('prestamos.index') }}"
        class="{{ request()->routeIs('prestamos.index') ? 'text-green-500' : 'text-gray-500' }} flex flex-col items-center text-md pt-2">
    ...
    <!-- Logout Button -->
    <button id="btn-logout-mobile" type="button" class="text-red-500 flex flex-col items-center text-md pt-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="size-5">
            <path stroke-linecap="round" stroke-linejoin="round"
